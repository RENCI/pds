...
def test_get_pds_patient_variables():
    resp = requests.post(f"http://localhost:8080/v1/plugin/pds/patientVariables", json={"ptid": "smart-7321938", "guidancePiid": "pdspi-guidance-example", "timestamp": "2020-02-19T00:00:00Z"}, headers=json_post_headers)
...
def test_get_pds_patient_variables_no_timestamp():
    resp = requests.post(f"http://localhost:8080/v1/plugin/pds/patientVariables", json={"ptid": "smart-7321938", "guidancePiid": "pdspi-guidance-example"}, headers=json_post_headers)
