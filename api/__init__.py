...
def getGuidance(patient_id, model, model_plugin_id, timestamp):
    features = getProfile(patient_id, model_plugin_id, timestamp)
...
def getProfile(patient_id, model_plugin_id, timestamp):
    ...
    url = f"{pds_url_base}/{profile_plugin_id}/profile?patient_id={patient_id}&model_plugin_id={model_plugin_id}&timestamp={timestamp}"
